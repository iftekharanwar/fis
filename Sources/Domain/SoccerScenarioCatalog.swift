...
enum SoccerScenarioCatalog {
    static let scenarios: [String: SoccerScenario] = [
        ...
        "soc-header-001": SoccerScenario(
            ...
            explainer: "The defenders close the direct lane to goal — a four-man wall here, deeper coverage than a normal free-kick. So you don't shoot at the goal: you curl the ball onto your teammate's head in the box. One touch redirects it past the keeper. Magnus delivers; the head finishes.",
            goalDistance: 26.0,
            wallDistance: 9.15,
            goalWidth: 7.32,
            ballVelocity: 26.0,
